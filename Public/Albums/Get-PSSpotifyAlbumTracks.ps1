function Get-PSSpotifyAlbumTracks {
    [CmdletBinding()]
    param (
        [Parameter(Mandatory)]
        [string]$AccessToken, 
    ...
    begin {
        ...
        $uri = "https://api.spotify.com/v1/albums/$AlbumId/tracks?limit=$ItemLimit"
    ...
    process {
        return (Invoke-RestMethod -Method Get -Uri $uri -Headers $header).items
